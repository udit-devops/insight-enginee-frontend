...
import toast from 'react-hot-toast'
import { uploadDocument, askQuestion } from '../services/api'
import type { UploadStatus, AskStatus, AskResponse } from '../types'
...
export function useInsightEngine() {
  ...
  return { uploadStatus, uploadProgress, uploadedFile, askStatus, response, handleUpload, handleAsk }
}